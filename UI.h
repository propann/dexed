...
LCDML_add(66, LCDML_0, 3, "E-Piano", UI_func_epiano);
LCDML_add(67, LCDML_0, 4, "Master Effects", NULL);
LCDML_add(68, LCDML_0_4, 1, "Reverb", NULL);
LCDML_add(69, LCDML_0_4_1, 1, "Roomsize", UI_func_reverb_roomsize);
LCDML_add(70, LCDML_0_4_1, 2, "Lowpass", UI_func_reverb_lowpass);
LCDML_add(71, LCDML_0_4_1, 3, "Lodamp", UI_func_reverb_lodamp);
LCDML_add(72, LCDML_0_4_1, 4, "Hidamp", UI_func_reverb_hidamp);
LCDML_add(73, LCDML_0_4_1, 5, "Diffusion", UI_func_reverb_diffusion);
LCDML_add(74, LCDML_0_4_1, 6, "Level", UI_func_reverb_level);
LCDML_add(75, LCDML_0_4_1, 7, "Reverb Send", UI_func_reverb_send);
LCDML_add(76, LCDML_0_4, 2, "EQ", NULL);
LCDML_add(77, LCDML_0_4_2, 1, "Low-Cut", UI_func_eq_1);
LCDML_add(78, LCDML_0_4_2, 2, "110Hz", UI_func_eq_2);
LCDML_add(79, LCDML_0_4_2, 3, "220Hz", UI_func_eq_3);
LCDML_add(80, LCDML_0_4_2, 4, "1000Hz", UI_func_eq_4);
LCDML_add(81, LCDML_0_4_2, 5, "2000Hz", UI_func_eq_5);
LCDML_add(82, LCDML_0_4_2, 6, "7000Hz", UI_func_eq_6);
LCDML_add(83, LCDML_0_4_2, 7, "High-Cut", UI_func_eq_7);
LCDML_add(84, LCDML_0, 5, "Sequencer", NULL);
LCDML_add(85, LCDML_0_5, 1, "Song", UI_func_song);
LCDML_add(86, LCDML_0_5, 2, "Pattern Editor", UI_func_seq_pattern_editor);
LCDML_add(87, LCDML_0_5, 3, "Tracker", UI_func_seq_tracker);
LCDML_add(88, LCDML_0_5, 4, "Arpeggio", UI_func_arpeggio);
LCDML_add(89, LCDML_0_5, 5, "Mute Matrix", UI_func_seq_mute_matrix);
LCDML_add(90, LCDML_0_5, 6, "PianoRoll", UI_func_seq_pianoroll);
LCDML_add(91, LCDML_0_5, 7, "Smart Filter", UI_func_smart_filter);
LCDML_add(92, LCDML_0_5, 8, "Settings", UI_func_seq_settings);
LCDML_addAdvanced (93, LCDML_0_5, 9, COND_hide, "Vel./Chrd Edit", UI_func_seq_vel_editor, 0, _LCDML_TYPE_default);
LCDML_add(94, LCDML_0, 6, "Mixer", UI_func_mixer);
LCDML_add(95, LCDML_0, 7, "Load/Save", NULL);
LCDML_add(96, LCDML_0_7, 1, "Load Perf.", UI_func_load_performance);
LCDML_add(97, LCDML_0_7, 2, "Save Perf.", UI_func_save_performance);
LCDML_add(98, LCDML_0_7, 3, "Name Perf.", UI_func_set_performance_name);
LCDML_add(99, LCDML_0_7, 4, "MIDI", NULL);
LCDML_add(100, LCDML_0_7_4, 1, "MIDI Recv Bank", UI_func_sysex_receive_bank);
LCDML_add(101, LCDML_0_7_4, 2, "MIDI Snd Bank", UI_func_sysex_send_bank);
LCDML_add(102, LCDML_0_7_4, 3, "MIDI Snd Voice", UI_func_sysex_send_voice);
LCDML_add(103, LCDML_0, 8, "System", NULL);
LCDML_add(104, LCDML_0_8, 1, "Stereo/Mono", UI_func_stereo_mono);
LCDML_add(105, LCDML_0_8, 2, "MIDI Soft THRU", UI_func_midi_soft_thru);
LCDML_add(106, LCDML_0_8, 3, "Favorites", UI_func_favorites);
LCDML_add(107, LCDML_0_8, 4, "Startup Perform.", UI_func_startup_performance);
LCDML_add(108, LCDML_0_8, 5, "Startup Page", UI_func_startup_page);
LCDML_add(109, LCDML_0_8, 6, "Colors", UI_func_colors);
LCDML_add(110, LCDML_0_8, 7, "FORMAT FLASH", UI_func_format_flash);
LCDML_add(111, LCDML_0, 9, "Sample Editor", UI_func_sample_editor);
LCDML_add(112, LCDML_0, 10, "File Manager", UI_func_file_manager);
LCDML_add(113, LCDML_0, 11, "Sampler", UI_func_phSampler);
LCDML_add(114, LCDML_0, 12, "Cust.DrumMap", UI_func_custom_mappings);
LCDML_add(115, LCDML_0, 13, "Cust. cc Map", UI_func_cc_mappings);
LCDML_add(116, LCDML_0, 14, "MicroSynth", UI_func_microsynth);
LCDML_add(117, LCDML_0, 15, "Info", UI_func_information);
LCDML_addAdvanced(118, LCDML_0, 17, COND_hide, "Volume", UI_func_volume, 0, _LCDML_TYPE_default);
LCDML_addAdvanced (119 , LCDML_0   , 18  , COND_hide,  "Screensaver"   , mFunc_screensaver,   0, _LCDML_TYPE_default);
