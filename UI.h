...
LCDML_add(117, LCDML_0_5, 4, "Tables", NULL);
LCDML_add(118, LCDML_0_5, 5, "Arpeggio", UI_func_arpeggio);
LCDML_add(119, LCDML_0_5, 6, "Mute Matrix", UI_func_seq_mute_matrix);
LCDML_add(120, LCDML_0_5, 7, "Tracker (Play)", UI_func_seq_tracker);
LCDML_add(121, LCDML_0_5, 8, "Tracker (Edit)", UI_func_seq_tracker_edit);
LCDML_add(122, LCDML_0_5, 9, "PianoRoll", UI_func_seq_pianoroll);
LCDML_add(123, LCDML_0_5, 10, "Seq. Settings", NULL);
LCDML_add(124, LCDML_0_5_10, 1, "Tempo", UI_func_seq_tempo);
LCDML_add(125, LCDML_0_5_10, 3, "Track Setup", UI_func_seq_track_setup);
LCDML_add(126, LCDML_0_5_10, 4, "Seq.Disp.Style", UI_func_seq_display_style);
LCDML_add(127, LCDML_0_5_10, 5, "Dexed Assign", UI_func_dexed_assign);
LCDML_add(128, LCDML_0_5_10, 6, "Shift&Transp.", UI_func_arp_shift);
LCDML_add(129, LCDML_0_5_10, 7, "Live Transpose", UI_func_seq_live_transpose_oct);
LCDML_add(130, LCDML_0_5_10, 8, "ChordTrack Keys", UI_func_seq_chord_keys_ammount);
LCDML_add(131, LCDML_0_5_10, 9, "Smart Filter", UI_func_smart_filter);
LCDML_add(132, LCDML_0, 6, "Mixer", UI_func_mixer);
LCDML_add(133, LCDML_0, 7, "Load/Save", NULL);
LCDML_add(134, LCDML_0_7, 1, "Load Perf.", UI_func_load_performance);
LCDML_add(135, LCDML_0_7, 2, "Save Perf.", UI_func_save_performance);
LCDML_add(136, LCDML_0_7, 3, "Name Perf.", UI_func_set_performance_name);
LCDML_add(137, LCDML_0_7, 4, "MIDI", NULL);
LCDML_add(138, LCDML_0_7_4, 1, "MIDI Recv Bank", UI_func_sysex_receive_bank);
LCDML_add(139, LCDML_0_7_4, 2, "MIDI Snd Bank", UI_func_sysex_send_bank);
LCDML_add(140, LCDML_0_7_4, 3, "MIDI Snd Voice", UI_func_sysex_send_voice);
LCDML_add(141, LCDML_0, 8, "System", NULL);
LCDML_add(142, LCDML_0_8, 1, "Stereo/Mono", UI_func_stereo_mono);
LCDML_add(143, LCDML_0_8, 2, "MIDI Soft THRU", UI_func_midi_soft_thru);
LCDML_add(144, LCDML_0_8, 3, "Favorites", UI_func_favorites);
LCDML_add(145, LCDML_0_8, 4, "Startup", UI_func_startup);
LCDML_add(146, LCDML_0_8, 5, "Colors", UI_func_colors);
LCDML_add(147, LCDML_0_8, 6, "FORMAT FLASH", UI_func_format_flash);
LCDML_add(148, LCDML_0, 9, "Sample Editor", UI_func_sample_editor);
LCDML_add(149, LCDML_0, 10, "File Manager", UI_func_file_manager);
LCDML_add(150, LCDML_0, 11, "Sampler", UI_func_phSampler);
LCDML_add(151, LCDML_0, 12, "Cust.DrumMap", UI_func_custom_mappings);
LCDML_add(152, LCDML_0, 13, "Cust. cc Map", UI_func_cc_mappings);
LCDML_add(153, LCDML_0, 14, "Info", UI_func_information);
LCDML_addAdvanced(154, LCDML_0, 15, COND_hide, "Volume", UI_func_volume, 0, _LCDML_TYPE_default);
LCDML_addAdvanced (155 , LCDML_0   , 16  , COND_hide,  "Screensaver"   , mFunc_screensaver,   0, _LCDML_TYPE_default);
#define _LCDML_DISP_cnt 155
#endif
