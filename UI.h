...
LCDML_add(87, LCDML_0_5, 3, "Vel./Chrd Edit", UI_func_seq_vel_editor);
LCDML_add(88, LCDML_0_5, 4, "Tracker", UI_func_seq_tracker);
LCDML_add(89, LCDML_0_5, 5, "Arpeggio", UI_func_arpeggio);
LCDML_add(90, LCDML_0_5, 6, "Mute Matrix", UI_func_seq_mute_matrix);
LCDML_add(91, LCDML_0_5, 7, "PianoRoll", UI_func_seq_pianoroll);
LCDML_add(92, LCDML_0_5, 8, "Smart Filter", UI_func_smart_filter);
LCDML_add(93, LCDML_0_5, 9, "Settings", UI_func_seq_settings);
