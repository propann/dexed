...
LCDML_add(96, LCDML_0_4, 6, "Tracker", UI_func_seq_tracker);
LCDML_add(97, LCDML_0_4, 7, "Seq. Settings", NULL);
LCDML_add(98, LCDML_0_4_7, 1, "Tempo", UI_func_seq_tempo);
LCDML_add(99, LCDML_0_4_7, 2, "Seq. Length", UI_func_seq_lenght);
LCDML_add(100, LCDML_0_4_7, 3, "Track Setup", UI_func_seq_track_setup);
LCDML_add(101, LCDML_0_4_7, 4, "Seq.Disp.Style", UI_func_seq_display_style);
LCDML_add(102, LCDML_0_4_7, 5, "Dexed Assign", UI_func_dexed_assign);
LCDML_add(103, LCDML_0_4_7, 6, "Shift&Transp.", UI_func_arp_shift);
LCDML_add(104, LCDML_0_4_7, 7, "Live Transpose", UI_func_seq_live_transpose_oct);
LCDML_add(105, LCDML_0_4_7, 8, "ChordTrack Keys", UI_func_seq_chord_keys_ammount);
LCDML_add(106, LCDML_0_4_7, 9, "Smart Filter", UI_func_smart_filter);
LCDML_add(107, LCDML_0_4, 8, "PianoRoll", UI_func_seq_pianoroll);
LCDML_add(108, LCDML_0, 5, "System", NULL);
LCDML_add(109, LCDML_0_5, 1, "Stereo/Mono", UI_func_stereo_mono);
LCDML_add(110, LCDML_0_5, 2, "MIDI Soft THRU", UI_func_midi_soft_thru);
LCDML_add(111, LCDML_0_5, 3, "Favorites", UI_func_favorites);
LCDML_add(112, LCDML_0_5, 4, "Startup", UI_func_startup);
LCDML_add(113, LCDML_0, 6, "Sample Editor", UI_func_sample_editor);
LCDML_add(114, LCDML_0, 7, "File Manager", UI_func_file_manager);
LCDML_add(115, LCDML_0, 8, "Info", UI_func_information);
LCDML_addAdvanced(116, LCDML_0, 9, COND_hide, "Volume", UI_func_volume, 0, _LCDML_TYPE_default);
