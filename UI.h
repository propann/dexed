...
LCDML_add(144, LCDML_0_8, 4, "Startup Perform.", UI_func_startup_performance);
LCDML_add(145, LCDML_0_8, 5, "Startup Page", UI_func_startup_page);
LCDML_add(146, LCDML_0_8, 6, "Colors", UI_func_colors);
LCDML_add(147, LCDML_0_8, 7, "FORMAT FLASH", UI_func_format_flash);
...
LCDML_add(153, LCDML_0, 14, "MicroSynth", UI_func_microsynth);
LCDML_add(154, LCDML_0, 15, "Info", UI_func_information);
LCDML_addAdvanced(155, LCDML_0, 16, COND_hide, "Volume", UI_func_volume, 0, _LCDML_TYPE_default);
LCDML_addAdvanced (156 , LCDML_0   , 17  , COND_hide,  "Screensaver"   , mFunc_screensaver,   0, _LCDML_TYPE_default);
#define _LCDML_DISP_cnt 156
#endif
