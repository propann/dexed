...
LCDML_add(102, LCDML_0_8, 4, "Name Multisample", UI_func_set_multisample_name);
LCDML_add(103, LCDML_0_8, 5, "MIDI", NULL);
LCDML_add(104, LCDML_0_8_5, 1, "MIDI Recv Bank", UI_func_sysex_receive_bank);
LCDML_add(105, LCDML_0_8_5, 2, "MIDI Snd Bank", UI_func_sysex_send_bank);
LCDML_add(106, LCDML_0_8_5, 3, "MIDI Snd Voice", UI_func_sysex_send_voice);
LCDML_add(107, LCDML_0, 9, "File Manager", UI_func_file_manager);
LCDML_add(108, LCDML_0, 10, "System", NULL);
LCDML_add(109, LCDML_0_10, 1, "Stereo/Mono", UI_func_stereo_mono);
LCDML_add(110, LCDML_0_10, 2, "MIDI Soft THRU", UI_func_midi_soft_thru);
LCDML_add(111, LCDML_0_10, 3, "Cust.DrumMap", UI_func_custom_mappings);
LCDML_add(112, LCDML_0_10, 4, "Cust. cc Map", UI_func_cc_mappings);
LCDML_add(113, LCDML_0_10, 5, "Favorites", UI_func_favorites);
LCDML_add(114, LCDML_0_10, 6, "Startup Perform.", UI_func_startup_performance);
...
LCDML_addAdvanced(123, LCDML_0, 15, COND_hide, "Volume", UI_func_volume, 0, _LCDML_TYPE_default);
LCDML_addAdvanced (124 , LCDML_0   , 16  , COND_hide,  "Screensaver"   , mFunc_screensaver,   0, _LCDML_TYPE_default);
#define _LCDML_DISP_cnt 124
#endif
