...
LCDML_addAdvanced (115, LCDML_0_5, 2, COND_hide, "Vel./Chrd Edit", UI_func_seq_vel_editor, 0, _LCDML_TYPE_default);
...
LCDML_add(124, LCDML_0_5_9, 2, "Seq. Length", UI_func_seq_lenght);
LCDML_add(125, LCDML_0_5_9, 3, "Track Setup", UI_func_seq_track_setup);
LCDML_add(126, LCDML_0_5_9, 4, "Seq.Disp.Style", UI_func_seq_display_style);
LCDML_add(127, LCDML_0_5_9, 5, "Dexed Assign", UI_func_dexed_assign);
LCDML_add(128, LCDML_0_5_9, 6, "Shift&Transp.", UI_func_arp_shift);
LCDML_add(129, LCDML_0_5_9, 7, "Live Transpose", UI_func_seq_live_transpose_oct);
LCDML_add(130, LCDML_0_5_9, 8, "ChordTrack Keys", UI_func_seq_chord_keys_ammount);
LCDML_add(131, LCDML_0_5_9, 9, "Smart Filter", UI_func_smart_filter);
LCDML_add(132, LCDML_0, 6, "Load/Save", NULL);
LCDML_add(133, LCDML_0_6, 1, "Load Perf.", UI_func_load_performance);
LCDML_add(134, LCDML_0_6, 2, "Save Perf.", UI_func_save_performance);
LCDML_add(135, LCDML_0_6, 3, "Name Perf.", UI_func_set_performance_name);
LCDML_add(136, LCDML_0_6, 4, "MIDI", NULL);
LCDML_add(137, LCDML_0_6_4, 1, "MIDI Recv Bank", UI_func_sysex_receive_bank);
LCDML_add(138, LCDML_0_6_4, 2, "MIDI Snd Bank", UI_func_sysex_send_bank);
LCDML_add(139, LCDML_0_6_4, 3, "MIDI Snd Voice", UI_func_sysex_send_voice);
LCDML_add(140, LCDML_0, 7, "System", NULL);
LCDML_add(141, LCDML_0_7, 1, "Stereo/Mono", UI_func_stereo_mono);
LCDML_add(142, LCDML_0_7, 2, "MIDI Soft THRU", UI_func_midi_soft_thru);
LCDML_add(143, LCDML_0_7, 3, "Favorites", UI_func_favorites);
LCDML_add(144, LCDML_0_7, 4, "Startup", UI_func_startup);
LCDML_add(145, LCDML_0_7, 5, "FORMAT FLASH", UI_func_format_flash);
LCDML_add(146, LCDML_0, 8, "Sample Editor", UI_func_sample_editor);
LCDML_add(147, LCDML_0, 9, "File Manager", UI_func_file_manager);
LCDML_add(148, LCDML_0, 10, "phPiano", UI_func_phPiano);
LCDML_add(149, LCDML_0, 11, "Cust.DrumMap", UI_func_custom_mappings);
LCDML_add(150, LCDML_0, 12, "Cust. cc Map", UI_func_cc_mappings);
LCDML_add(151, LCDML_0, 13, "Info", UI_func_information);
LCDML_addAdvanced(152, LCDML_0, 14, COND_hide, "Volume", UI_func_volume, 0, _LCDML_TYPE_default);
LCDML_addAdvanced (153 , LCDML_0   , 15  , COND_hide,  "Screensaver"   , mFunc_screensaver,   0, _LCDML_TYPE_default);
#define _LCDML_DISP_cnt 153
#endif
