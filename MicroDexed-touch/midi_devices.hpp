...
{
 // liveSeq.handleMidiEvent(event, inData1, inData2);  // when playing on an external MIDI keyboard, every note is also played by drumchannel in addition to current MIDI channel
#ifdef DEBUG
  char text[10];
#endif
