...
public:
  ...
  ValueButton<T>(active, x_coord, y_coord, new EditableValueVector<T>(invalue, invalues, defaultValue, [ draw, this ](EditableValue<T> *v) { draw(this, v); }), draw) {}
};
...
public:
  ...
  ValueButton<T>(active, x_coord, y_coord, new EditableValueRange<T>(invalue, min, max, increment, defaultValue, [ draw, this ](EditableValue<T> *v) { draw(this, v); }), draw) {}
};
