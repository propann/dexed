...
{
  P_uint8_t(pool,0,0x7FFF,0);
  P_uint8_t(bank,0,MAX_BANKS - 1,0);
  P_uint8_t(voice,0,MAX_VOICES-1,0);
  P_uint8_t(lowest_note,21,108,21);
  P_uint8_t(highest_note,21,108,108);
  P_uint8_t(transpose,0,48,12);
  P_uint8_t(tune,1,199,100);
  P_uint8_t(sound_intensity,0,100,100);
  P_uint8_t(pan,0,40,20);
  P_uint8_t(polyphony,0,MAX_NOTES,MAX_NOTES / NUM_DEXED);
  P_uint8_t(velocity_level,50,127,100);
  P_uint8_t(monopoly,0,1,0);
  P_uint8_t(note_refresh,0,1,0);
  P_uint8_t(pb_range,0,12,1);
  P_uint8_t(pb_step,0,12,0);
  P_uint8_t(mw_range,0,99,50);
  P_uint8_t(mw_assign,0,7,0); // Bitmapped: 0: Pitch, 1: Amp, 2: Bias
  P_uint8_t(mw_mode,0,MIDI_CONTROLLER_MODE_MAX,0);
  P_uint8_t(fc_range,0,99,50);
  P_uint8_t(fc_assign,0,7,0); // Bitmapped: 0: Pitch, 1: Amp, 2: Bias
  P_uint8_t(fc_mode,0,MIDI_CONTROLLER_MODE_MAX,0);
  P_uint8_t(bc_range,0,99,50);
  P_uint8_t(bc_assign,0,7,0); // Bitmapped: 0: Pitch, 1: Amp, 2: Bias
  P_uint8_t(bc_mode,0,MIDI_CONTROLLER_MODE_MAX,0);
  P_uint8_t(at_range,0,99,50);
  P_uint8_t(at_assign,0,7,0); // Bitmapped: 0: Pitch, 1: Amp, 2: Bias
  P_uint8_t(at_mode,0,MIDI_CONTROLLER_MODE_MAX,0);
  P_uint8_t(portamento_mode,0,1,0); // 0: Retain, 1: Follow
  P_uint8_t(portamento_glissando,0,1,0);
  P_uint8_t(portamento_time,0,99,0);
...
{
  P_uint8_t(decay,0,100,50);
  P_uint8_t(release,0,100,50);
  P_uint8_t(hardness,0,100,50);
  P_uint8_t(treble,0,100,50);
  P_uint8_t(pan_tremolo,0,100,20);
  P_uint8_t(pan_lfo,0,100,65);
  P_uint8_t(velocity_sense,0,100,25);
  P_uint8_t(stereo,0,100,50);
  P_uint8_t(polyphony,0,NUM_EPIANO_VOICES,NUM_EPIANO_VOICES);
  P_uint8_t(tune,1,199,100);
  P_uint8_t(detune,0,100,15);
  P_uint8_t(overdrive,0,100,0);
  P_uint8_t(lowest_note,21,108,EP_LOWEST_NOTE_MIN);
  P_uint8_t(highest_note,21,108,EP_LOWEST_NOTE_MAX);
  P_uint8_t(transpose,0,48,24);
  P_uint8_t(sound_intensity,SOUND_INTENSITY_MIN,SOUND_INTENSITY_MAX, SOUND_INTENSITY_MAX/2);
  P_uint8_t(pan,0,40,20);
  P_uint8_t(midi_channel,0,16,1);
...
{
  P_int32_t(coarse,-36,36,0);
  P_int32_t(detune, -99, 99, 0);
  P_int32_t(lfo_intensity,0, 254,0);
  P_int32_t(lfo_delay, 0, 254, 0);
  P_uint8_t(lfo_mode, 0, 2, 1);
  P_uint8_t(lfo_speed, 0, 254, 0);
  // internal lfo values
  P_uint8_t(lfo_direction,0,1,0);
  P_int32_t(lfo_value,-0x3FFE,0x3FFF,0);
  P_int32_t(lfo_fade,-0x3FFE,0x3FFF,0);
  P_uint8_t(trigger_noise_with_osc,0,1,0);
  P_uint8_t(pan,PANORAMA_MIN,PANORAMA_MAX,PANORAMA_MAX/2);
  P_uint8_t(wave,0,8,0);
  P_uint8_t(midi_channel,1,16,1);
  P_uint8_t(sound_intensity,0,100,50);
  P_uint8_t(env_attack, 0, 254, 0);
  P_uint8_t(env_decay, 0, 254, 11);
  P_uint8_t(env_sustain, 0, 50, 4);
  P_uint8_t(env_release, 0, 99, 8);
  P_uint8_t(filter_osc_mode,0,3,0);
  P_uint16_t(osc_freq_current,0,15000,0);
  P_uint16_t(filter_osc_freq_from,0,15000,0);
  P_uint16_t(filter_osc_freq_to,0,15000,15000);
  P_uint16_t(filter_osc_freq_current,0,15000,0);
  P_uint16_t(filter_osc_freq_last_displayed,0,15000,0);
  P_uint16_t(filter_osc_speed,0,999,0);
  P_uint8_t(filter_osc_resonance,0,99,0);
  P_uint8_t(noise_vol,0,100,0);
  P_uint8_t(noise_decay,0,100,0);
  P_uint8_t(filter_noise_mode,0,3,1);
  P_uint16_t(filter_noise_freq_from, 0, 15000,0);
  P_uint16_t(filter_noise_freq_to, 0, 15000, 15000);
  P_uint16_t(filter_noise_freq_current, 0, 15000, 0);
  P_uint16_t(filter_noise_speed,0,999,0);
  P_uint8_t(filter_noise_resonance,0,99,0);
  P_uint16_t(pwm_from, 0, 999, 0);
  P_uint16_t(pwm_to, 0, 999, 0);
  P_uint8_t(pwm_speed, 0, 99, 0);
  P_uint16_t(pwm_current, 0, 99, 0);
  P_uint16_t(pwm_last_displayed, 0, 99, 0);
  P_uint8_t(rev_send,0,100,0);
  P_uint8_t(chorus_send,0,100,0);
  P_uint8_t(delay_send_0,0,100,0);
  P_uint8_t(delay_send_1,0,100,0);
...
{
  P_uint8_t(sound_intensity, 0, 100, 100);
  P_uint8_t(algo, 0, 42, 0);
  P_uint8_t(color, 0, 255, 100);
  P_uint8_t(timbre, 0, 255, 100);
  P_int32_t(coarse, -36, 36, 0);
  P_uint8_t(env_attack, 0, 255,0);
  P_uint8_t(env_decay, 0, 255,50);
  P_uint8_t(env_sustain, 0, 50,20);
  P_uint8_t(env_release, 0, 99,20);
  P_uint8_t(filter_mode, 0, 3, 1);
  P_uint16_t(filter_freq_from, 0, 15000, 0);
  P_uint16_t(filter_freq_to, 0, 15000, 15000);
  P_uint8_t(filter_resonance, 0, 99, 20);
  P_uint16_t(filter_speed, 0, 999, 20);
  P_uint16_t(filter_lfo_intensity, 0, 15000, 1000);
  P_uint8_t(filter_lfo_speed, 0, 255, 20);
  P_uint8_t(rev_send, 0, REVERB_SEND_MAX ,0);
  P_uint8_t(flanger, 0, REVERB_SEND_MAX,0);
  P_uint8_t(flanger_spread, 0, REVERB_SEND_MAX,0);
  P_uint8_t(delay_send_1, 0, DELAY_LEVEL_MAX,0);
  P_uint8_t(delay_send_2, 0, DELAY_LEVEL_MAX,0);
  P_uint8_t(midi_channel,0,16,2);
  P_uint8_t(pan, PANORAMA_MIN, PANORAMA_MAX,PANORAMA_MAX/2);
  P_end;
