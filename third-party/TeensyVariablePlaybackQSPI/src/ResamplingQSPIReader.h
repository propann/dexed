...
#ifndef TEENSYAUDIOLIBRARY_RESAMPLINGQSPIREADER_H
#define TEENSYAUDIOLIBRARY_RESAMPLINGQSPIREADER_H
...
class ResamplingQSPIReader {
public:
    ResamplingQSPIReader() {
    }
...
#endif //TEENSYAUDIOLIBRARY_RESAMPLINGQSPIREADER_H
